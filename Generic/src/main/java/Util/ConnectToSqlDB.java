...
public class ConnectToSqlDB {
    ...
    public static Properties loadProperties() throws IOException{
        ...
        InputStream ism = new FileInputStream("/Users/nazibahfariha/Downloads/TeamAutomation2018-master/Generic/lib/MySQL.properties");
        prop.load(ism);
        ism.close();
        return prop;
    }
    ...
    public static List<User> readUserProfileFromSqlTable()throws IOException, SQLException, ClassNotFoundException{
        ...
        try{
            ...
            String query = "SELECT * FROM DataToBeSearched";
